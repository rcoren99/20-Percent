 ...
 * 
 */
public class SafeNoMultUsers implements ActionListener
{
    private static ArrayList<Password> vault=new ArrayList<Password>();
    private static char[] mainPassword={'n','o','o'};
    ...
    private static String FILESCREEN="File chooser screen";
    ...
    public SafeNoMultUsers(){
        ...
        contentPane.add(filePane,FILESCREEN);
    ...
    public void chooseFileScreenGUI(){
        chooser=new JFileChooser();
        chooser.addActionListener(this);

        JLabel message=new JLabel("Choose the file to export data into");
        ...
        c.gridx = 1;
        c.gridy = 1;
        filePane.add(chooser,c);
        c.fill = GridBagConstraints.HORIZONTAL;
        c.gridx = 1;
        c.gridy = 0;
        filePane.add(message,c);
    }
    ...
    private void setScreen(int x){
        ...
        switch(x){
            ...
            break;
            case 7:
            cl.show(contentPane,FILESCREEN);
            break;
            default:
    ...
    public void exportData(){
        try{
            ...
            pw.println("</vault>");
            //pw.println("<mainPass>"+changeToString(mainPass)+"</mainPass>");
